      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          ...
          <p
            ...
            data-aos={"fade-left"}
          >
             Haloo aku Yohanda Gita Pratiwi, mahasiswa Pendidikan Ilmu Komputer di Universitas Pendidikan Indonesia.
             Lahir di Bandung pada 25 September 2003, ia memiliki semangat tinggi dalam mempelajari teknologi.
             Keahliannya dalam analisis dan dedikasinya untuk terus belajar membuatnya proaktif dalam
             mengikuti perkembangan teknologi. Yohanda juga memiliki jiwa kepemimpinan yang terlihat dari
             keterlibatannya dalam kegiatan kampus. Keseluruhannya, dia adalah individu yang bersemangat,
             fokus pada pengembangan pengetahuan di bidang ilmu komputer, dan memiliki bakat kepemimpinan yang
             kuat..
          </p>
          {/* <p
